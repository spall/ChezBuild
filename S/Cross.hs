...
xboot :: FilePath -> String -> Mach -> Integer -> Integer -> S.Config -> S.Config -> Run ()
xboot base what om o d c@S.Config{..} c2 = do
  ...
  case what of
    "all" -> do
      ...
      liftIO $ D.createDirectoryIfMissing True $ "../boot/tmp" </> showMach m
